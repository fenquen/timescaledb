...
extern SubspaceStore *ts_subspace_store_init(const Hyperspace *hyperspace, MemoryContext mcxt,
											 int16 max_items);

/* Store an object associate with the subspace represented by a hypercube */
extern void ts_subspace_store_add(SubspaceStore *subspaceStore, const Hypercube *hypercube, void *object,
 ...
 */
extern void *ts_subspace_store_get(const SubspaceStore *subspaceStore, const Point *target);
