...
typedef struct Hypercube {
	...
	int16 num_slices; /* actual number of slices (should equal capacity after create) */
	DimensionSlice *slices[FLEXIBLE_ARRAY_MEMBER];/* Slices are stored in dimension order */
} Hypercube;
